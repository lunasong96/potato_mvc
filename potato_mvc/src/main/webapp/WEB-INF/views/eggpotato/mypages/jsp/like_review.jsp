...
<c:forEach var="l" items="${ lAll }">
		...
		<div class="re-right">
			<div style="margin-bottom: 10px;">
				...
				border-radius: 7px;"><a href="user_detailed.do?restarea_idx=${l.restarea_idx }"><c:out value="${l.name}"/></a></span>
			</div>	
			...
			<p class="re-txt">
				<c:out value="${l.contents}" escapeXml="false"/>
			</p>
			
			<c:if test="${ not empty l.foodimg }">
			<div class="re-slider">
			...
			<div class="etc-icon-wrap">
				<div class="etc-icon" value="${l.id }">
					<div class="heart-icon-wrap" value="${l.restarea_idx}">
						<button type="button" class="heart-btn hb-fill" value="${l.review_idx}">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
							  <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
							</svg>
						</button>
						<span>좋아요(<span><c:out value="${l.liked}"/></span>)</span>
					</div>
					<c:if test="${l.id ne id }">
						<div class="report-icon">
							<button type="button" class="report-btn" onclick='javascript:reportMove(${l.review_idx},${l.restarea_idx},"${l.nick}","${l.id}");'>
					...
					<c:if test="${l.id eq id }">
						<div class="edit-icon">
							<a href="javascript:editR(${l.review_idx},${l.restarea_idx});"  value="${l.restarea_idx}">
						...
						<div class="delete-icon">
							<button type="button" class="delete-btn" onclick='javascript:deleteR(${l.review_idx},${l.restarea_idx});'>
