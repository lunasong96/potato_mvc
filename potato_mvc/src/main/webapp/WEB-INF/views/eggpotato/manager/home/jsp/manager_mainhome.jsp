...
<!-- 건들지마세요 -->
	<div style="display: flex;border-bottom: 1px solid grey;align-items: center; margin-bottom: 20px;">
		...
		<div class="top">
		<div class="board"><span class="board-text-1">누적신고 수</span><br><span class="board-text-2">건</span></div>
		...
		<div class="top">
		<div class="board"><span class="board-text-1">인기 휴게소</span><br><span class="board-text-2"></span></div>
		...
		<div class="top">
		<div class="board"><span class="board-text-1">관심 휴게소</span><br><span class="board-text-2"></span></div>
		...
		<div><!-- 3 -->
			...
			<div  class="graph2-list">
				...
				<a href="memberManagement.do"><p style="color: #333"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
